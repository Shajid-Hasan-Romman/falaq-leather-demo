...
/**
 * Shared SVG icon — "delivery" (vuesax/linear "group" glyph, the truck in the
 * checkout "Select your delivery area" header). Figma-generated style icon
...
export class IcDeliveryComponent {
